...
<form id="SsmResourceForm" method="post">
    <table class="com_table" align="center">
        ...
        <tr>
            ...
            <td>
                <a href="#" class="easyui-linkbutton" onclick="javascript:SsmResource.input.chooseIcon()">选择</a>
            </td>
        </tr>
        <tr>
            <td></td>
...
<script src="<%=request.getContextPath()%>/jsp/resource/ssm-resource.js"></script>
<script>
    SsmResource.input.init();
</script>